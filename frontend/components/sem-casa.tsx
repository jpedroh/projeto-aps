...
export function SemCasa() {
  ...
  function handleSubmit<T>(evt: FormEvent<HTMLFormElement>) {
    evt.preventDefault()
    return Object.fromEntries(new FormData(evt.target as any)) as T
  }
  ...
  return <div className='flex flex-col items-center'>
    ...
    <div className='flex gap-6'>
      <div className='flex flex-col gap-4 p-6 rounded-xl'>
        ...
        <form className='flex flex-col gap-2' onSubmit={evt => criarCasa.mutate(handleSubmit(evt))}>
      ...
      <div className='flex flex-col gap-4 p-6 rounded-xl'>
        ...
        <form className='flex flex-col gap-2' onSubmit={evt => entrarCasa.mutate(handleSubmit(evt))}>
