  ...
  return <div className='flex flex-col gap-6'>
    ...
    <div className='flex gap-6'>
      <div className='border p-6 flex flex-col gap-4 border-black rounded-xl'>
        <div className='self-center'><Image alt="Tarefas" src={tarefas} width={30} height={30} /></div>
      ...
      <div className='border p-6 flex flex-col gap-4 border-black rounded-xl'>
        <div className='self-center'><Image alt="Finanças" src={financas} width={30} height={30} /></div>
